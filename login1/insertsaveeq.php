...
if(empty($equipment_id)){
    ...
    $insertHub = 'INSERT INTO hub (equipment_type,equipment_id, hub_create_date, hub_update_date, hub_create_user, hub_update_user)
            VALUES ("'.$equipment_type.'",'.$eqId .', CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,"'.$user.'","'.$user.'")';
