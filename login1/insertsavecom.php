...
if(empty($equipment_id)){
    ...
    $insertCom = 'INSERT INTO computer (computer_OS, computer_updateOS, computer_start, computer_end, equipment_type,equipment_id, computer_create_date,computer_update_date,computer_create_user,computer_update_user)
            VALUES ("'.$computer_OS.'" , "'.$computer_updateOS.'", "'.$computer_start.'", "'.$computer_end.'", "'.$equipment_type.'","'.$eqId.'", CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,"'.$user.'","'.$user.'")';
