...
<body>
  ...
  <ul class="nav nav-tabs">
    ...
    <li class="active"><a href="saveser.php">เพิ่มข้อมูลเซิร์ฟเวอร์</a></li>
        ...
        <div class="panel panel-info">
          <div class="panel-body">
            ...
            <form id="formData">
              <?php
                  if(!empty($_GET['id'])){
                    $sql3 = 'SELECT equipment.equipment_id,
                         ...
                         FROM equipment
                         left JOIN servers
                         ON equipment.equipment_id =servers.equipment_id
                         JOIN parameterdetail type
                         ON type.param_code = equipment.equipment_type AND type.param_no = 100 AND type.param_code=2
              ...
              ?>
              <center style="padding-right:3%;">
                <input type="hidden" value="<?php echo $data['equipment_id'] ?>" name="equipment_id"/>
              <table>&nbsp;
                     <tr><td><font size="3 "align="left" >
                        <?php
                           $sql2 = 'SELECT param_code,param_endesc FROM parameterdetail where param_no =100 and param_code=2 order by param_code';
                ...
                <tr><td><font size="3 "align="left">หมายเลขอุปกรณ์ <font COLOR=red>*</font> : </font></td><td><font size="3 "align="left">
                  ...
                  <tr><td><font size="3 "align="left">IP address <font COLOR=red>*</font> : </font></td><td><font size="3 "align="left">
                    <input type="text" name="servers_ipAddress" value="<?php echo $data['servers_ipAddress'] ?>"> &nbsp;
                   ผู้ดูแล <font COLOR=red>*</font> : <input type="text" name="servers_conservator" value="<?php echo $data['servers_conservator'] ?>"></font></td></tr>
              ...
              <table>&nbsp;
                ...
                <tr><td><font size="3 "align="left">หมายเลขอุปกรณ์ <font COLOR=red>*</font> : </font></td><td><font size="3 "align="left">
                  <input type="text" name="equipment_num" /></font> &nbsp;<font size="3 "align="left">
                  ...
                  <tr><td><font size="3 "align="left">IP address <font COLOR=red>*</font> : </font></td><td><font size="3 "align="left">
                    <input type="text" name="servers_ipAddress"> &nbsp;
                   ผู้ดูแล <font COLOR=red>*</font> : <input type="text" name="servers_conservator" ></font></td></tr>

                   <td><br></td>

                   <tr><td><font size="3 "align="left"> วันที่รับเข้ามา <font COLOR=red>*</font> : </font></td><td>
                   <font size="3 "align="left"><input id="datepicker" class="date-picker" type="text" name="equipment_date" >
                   &nbsp;<i class="fa fa-calendar" style="font-size:24px"></i></font></td></tr>
      ...
      $(document).ready(function(){
        ...
        $("#formData").validate({
            rules: {
              ...
              servers_ipAddress: "required",
              servers_conservator: "required",
