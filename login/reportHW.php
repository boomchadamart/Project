...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h3 class="page-header"><a href="logout.php"><h5 align="left" style="padding-left:93%;color:black"><i class="fa fa-sign-out" style="font-size:18px;color:black"></i> Log out</i></h5></a>รายงานด้าน Configuration Management  <br><br><a href="index.php">หน้าแรก </a>| ข้อมูลฮาร์ดแวร์</small>  &nbsp;
                <small>  </small>
              </h3>
            </div>
        </div>
      ...
      <tbody>
        <?php
           ...
           while ($row = $status->fetch_array()) {
              ...
              echo '  <td>'.$row['equipment_HWdetail'].'</td>';
