...
if(empty($equipment_id)){
    ...
    if($equipment_type=2){
        $insertSer = 'INSERT INTO servers (servers_ipAddress, servers_conservator, equipment_type, servers_create_date, servers_update_date, servers_create_user, servers_update_user)
                      VALUES ("'.$servers_ipAddress.'" , "'.$servers_conservator.'", "'.$equipment_type.'", CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,"'.$user.'","'.$user.'")';
