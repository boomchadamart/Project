      ...
      <form id="formData">
        ...
        <table>&nbsp;
          ...
          <tr><td><font size="3 "align="left">หมายเลขอุปกรณ์ <font COLOR=red>*</font> : </font></td><td><font size="3 "align="left">
            ...
            <tr><td><font size="3"align="left" >ซอฟต์แวร์ระบบ: </font></td><td><font size="3 " align="left" >
              <input type="text" name="computer_OS"  value="<?php echo $data['computer_OS']?>"/></font>
              &nbsp;<font size="3 " align="left" >อัพเดทล่าสุด: <input type="text" class="date-picker" name="computer_updateOS" value="<?php echo $data['computer_updateOS']?>"></td></tr></front>
